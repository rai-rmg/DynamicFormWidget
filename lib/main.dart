...
class DynamicFormPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        children: [
          DynamicFormWidget(formFields: getFormFields()),
        ],
      ),
    );
  }
...
class DynamicFormWidget extends StatefulWidget {
  ...
  DynamicFormWidget({required this.formFields});
      ...
      child: Column(
        children: [
          ...getFormFields().map((field) {
            ...
            Widget inputWidget = Text('Initial Widget');
            if (answerType == 'text') {
              ...
              inputWidget = DropdownButtonFormField<String>(
                value: _formData[id],
                items: selectOptions.map<DropdownMenuItem<String>>((option) {
